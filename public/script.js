...
function renderCards() {
    ...
    hospitals.forEach(function(hospital) {
        ...
        var noOfPatientsDisplay = hospital.no_of_patients ? '<p>Total number of patients: <strong>' + hospital.no_of_patients + '</strong></p>' : '';
        ...
        card.innerHTML = '<h3>' + hospital.name + '</h3>' +
                         '<p>Distance: <strong>' + distanceDisplay + '</strong></p>' +
                         waitTimeDocDisplay +
                         noOfPatientsDisplay +
