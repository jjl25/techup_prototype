...
function renderCards() {
    ...
    hospitals.forEach(function(hospital) {
        ...
        var waitTimeDocDisplay = hospital.wait_time_doc ? '<p><i class="fa-solid fa-stethoscope"></i> <strong>' + hospital.wait_time_doc + '</strong> to see doctor</p>' : '';
        var noOfPatientsDisplay = hospital.no_of_patients ? '<p><i class="fa-solid fa-user-group"></i> <strong>' + hospital.no_of_patients + '</strong> patients in queue</p>' : '';
